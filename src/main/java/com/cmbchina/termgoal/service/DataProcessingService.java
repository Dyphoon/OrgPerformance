...
import com.cmbchina.termgoal.entity.*;
import com.cmbchina.termgoal.excel.ExcelDataReader;
import com.cmbchina.termgoal.excel.ExcelGenerator;
import com.cmbchina.termgoal.excel.ExcelTemplateParser;
import com.cmbchina.termgoal.mapper.*;
...
public class DataProcessingService {
    ...
    @Transactional
    public int batchSubmitTasks(List<com.cmbchina.termgoal.dto.TaskUpdateRequest> updates) {
        int count = 0;
        for (com.cmbchina.termgoal.dto.TaskUpdateRequest update : updates) {
